...
full_time_result_tips = ['Játekidö eredmenye', 'Jatekidé eredménye', 'full time result', 'Jatékidd eredménye',
                         'Jatékidé eredménye', 'Full Time Result']
full_time_draw_tips = ['Draw', 'draw', 'Déntetlen']
goal_line_tips = ['Goal Line', 'Cólok száma', 'goal line', 'goal tine']
nicknames = {'golancer': 'oolancer', 'std': 'stdm', 'qolancer': 'oolancer', 'milly': 'miliy', 'kivichds': 'kivich49',
             'crime': 'cr1me', 'kiset': 'kiser', 'nik83': 'nik33', 'zzakk!': 'zzakki', 'makewelllm': 'makcwelllm'}
